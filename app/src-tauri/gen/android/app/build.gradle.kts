...
dependencies {
    ...
    // Misma version que usa tauri-plugin-native-audio (sus dependencias son
    // `implementation`, no se heredan). Se usan para envolver el player de su
    // MediaSession, ver MainActivity.kt.
